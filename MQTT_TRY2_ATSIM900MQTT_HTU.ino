...
SoftwareSerial GPRS(16, 17); //RX, TX
//but is more 'smooth'
#define NUMSAMPLES 5
...
void loop (){
 ...
 // get_HTU();
  ...
  if(gprsReady == true){
    ...
    sendMQTTMessage("OBD2", "137.251.108.210", "443", "OBD2/", "Hello There!!");
  }
  delay (15000);
}
...
// digitalWrite(13, HIGH);
 GPRS.println("AT+CSTT=\"internet.t-mobile\",\"\",\"\""); // Puts phone into GPRS mode
 Serial.println("AT+CSTT=\"internet.t-mobile\",\"\",\"\"");
